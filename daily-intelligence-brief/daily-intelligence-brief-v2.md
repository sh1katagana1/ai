...
## OpenRouter
Go to https://openrouter.ai and sign up and setup an API Key. You can have multiple API Keys for different projects. You can also set a credit limit if you are using paid models. For this tutorial I will be using some of their free models that I found to be working each time I ran them and gave me good output. Something I did notice if your using the free models, these are heavily limited to what I believe is 50 requests a day for free models. I noticed this when I started running this and the AI portions for fingerprint analysis all completed successfully, but when it got to the AI summarization at the end, the first 15 succeeded but the rest failed with a 429 error. After doing some research, it seems that if you put any money at all in your credit pool, even if its not consumed, this bumps your daily requests to 1000. Once I added a small amount of money to my credit pool, all my AI steps succeeded. 
